...
| Rings around the enemy flag at 1 km, 500 m, 200 m and 50 m, on enemy ground. Crossing into a tighter one than any yet this approach is announced once: to the hunter (privately), to the defenders (with the hunter's name) and on the city radio. Never where: only the name and the ring. The 1 km ring also asks the hunter to go live | `GameEngine.nearFlag`, `GameRules.FLAG_RINGS_M` |
