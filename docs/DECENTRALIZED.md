...
The first node (`node/`) proves the core loop, not the whole design:
...
Later: quorum ordering, NIP-44 secrets, key attestation, media store, matcher, replacement and pause.
